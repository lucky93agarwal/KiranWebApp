...
class GroupOfficeStaffUsersDialog extends StatefulWidget {
  final String groupId;
  const GroupOfficeStaffUsersDialog({Key? key,   required this.groupId,}) : super(key: key);

  @override
  State<GroupOfficeStaffUsersDialog> createState() => _GroupOfficeStaffUsersDialogState();
}

class _GroupOfficeStaffUsersDialogState extends State<GroupOfficeStaffUsersDialog> {
